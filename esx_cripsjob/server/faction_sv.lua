...
RegisterServerEvent('esx_crips:buyItem')
AddEventHandler('esx_crips:buyItem', function()
...
RegisterServerEvent('esx_crips:buyItem1')
AddEventHandler('esx_crips:buyItem1', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_crips', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_crips', function(inventory)
...
RegisterServerEvent('esx_crips:buyItem2')
AddEventHandler('esx_crips:buyItem2', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_crips', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_crips', function(inventory)
...
RegisterServerEvent('esx_crips:getStockItemsBandits')
AddEventHandler('esx_crips:getStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_crips:getStockItemsBandits',function(source, cb)
...
-- RegisterServerEvent('esx_crips:putStockItemsBandits')
-- AddEventHandler('esx_crips:putStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_crips:putStockItemsBandits',function(source, cb)
...
RegisterServerEvent('esx_crips:startHarvestBandits')
AddEventHandler('esx_crips:startHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopHarvestBandits')
AddEventHandler('esx_crips:stopHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startHarvest2Bandits')
AddEventHandler('esx_crips:startHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopHarvest2Bandits')
AddEventHandler('esx_crips:stopHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startHarvest3Bandits')
AddEventHandler('esx_crips:startHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopHarvest3Bandits')
AddEventHandler('esx_crips:stopHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startHarvest4Bandits')
AddEventHandler('esx_crips:startHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopHarvest4Bandits')
AddEventHandler('esx_crips:stopHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startCraftBandits')
AddEventHandler('esx_crips:startCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopCraftBandits')
AddEventHandler('esx_crips:stopCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startCraft2Bandits')
AddEventHandler('esx_crips:startCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopCraft2Bandits')
AddEventHandler('esx_crips:stopCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:startCraft3Bandits')
AddEventHandler('esx_crips:startCraft3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_crips:stopCraft3Bandits')
AddEventHandler('esx_crips:stopCraft3Bandits', function()
  local _source = source
...
-- ESX.RegisterServerCallback('esx_crips:getArmoryWeaponsBandits',function(source, cb)
...
ESX.RegisterServerCallback('esx_crips:addArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_crips:removeArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_crips:buyBandits',function(source, cb, amount)
...
-----------------------------------------------------------------------------------------------------------------------
ESX.RegisterServerCallback('esx_crips:getBlackMoneySociety', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
  local blackMoney = 0
  local items      = {}
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_crips_weapons', function(store)
...
ESX.RegisterServerCallback('esx_crips:getPlayerInventory2', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
