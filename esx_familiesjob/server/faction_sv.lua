...
RegisterServerEvent('esx_families:buyItem')
AddEventHandler('esx_families:buyItem', function()
...
RegisterServerEvent('esx_families:buyItem1')
AddEventHandler('esx_families:buyItem1', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_families', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_families', function(inventory)
...
RegisterServerEvent('esx_families:buyItem2')
AddEventHandler('esx_families:buyItem2', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_families', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_families', function(inventory)
...
TriggerEvent('esx_society:registerSociety', 'families', 'families', 'society_families', 'society_families', 'society_families', {type = 'private'})
...
RegisterServerEvent('esx_families:getStockItemsBandits')
AddEventHandler('esx_families:getStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_families:getStockItemsBandits',function(source, cb)
...
-- RegisterServerEvent('esx_families:putStockItemsBandits')
-- AddEventHandler('esx_families:putStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_families:putStockItemsBandits',function(source, cb)
...
RegisterServerEvent('esx_families:startHarvestBandits')
AddEventHandler('esx_families:startHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopHarvestBandits')
AddEventHandler('esx_families:stopHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startHarvest2Bandits')
AddEventHandler('esx_families:startHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopHarvest2Bandits')
AddEventHandler('esx_families:stopHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startHarvest3Bandits')
AddEventHandler('esx_families:startHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopHarvest3Bandits')
AddEventHandler('esx_families:stopHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startHarvest4Bandits')
AddEventHandler('esx_families:startHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopHarvest4Bandits')
AddEventHandler('esx_families:stopHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startCraftBandits')
AddEventHandler('esx_families:startCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopCraftBandits')
AddEventHandler('esx_families:stopCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startCraft2Bandits')
AddEventHandler('esx_families:startCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopCraft2Bandits')
AddEventHandler('esx_families:stopCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:startCraft3Bandits')
AddEventHandler('esx_families:startCraft3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_families:stopCraft3Bandits')
AddEventHandler('esx_families:stopCraft3Bandits', function()
  local _source = source
...
-- ESX.RegisterServerCallback('esx_families:getArmoryWeaponsBandits',function(source, cb)
...
ESX.RegisterServerCallback('esx_families:addArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_families:removeArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_families:buyBandits',function(source, cb, amount)
...
-----------------------------------------------------------------------------------------------------------------------
ESX.RegisterServerCallback('esx_families:getBlackMoneySociety', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
  local blackMoney = 0
  local items      = {}
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_families_weapons', function(store)
...
ESX.RegisterServerCallback('esx_families:getPlayerInventory2', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
