...
RegisterServerEvent('esx_mafia:buyItem')
AddEventHandler('esx_mafia:buyItem', function()
...
RegisterServerEvent('esx_mafia:buyItem1')
AddEventHandler('esx_mafia:buyItem1', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_mafia', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mafia', function(inventory)
...
RegisterServerEvent('esx_mafia:buyItem2')
AddEventHandler('esx_mafia:buyItem2', function()
  	TriggerEvent('esx_addonaccount:getSharedAccount', 'society_mafia', function(account)
	TriggerEvent('esx_addoninventory:getSharedInventory', 'society_mafia', function(inventory)
...
RegisterServerEvent('esx_mafia:getStockItemsBandits')
AddEventHandler('esx_mafia:getStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_mafia:getStockItemsBandits',function(source, cb)
...
-- RegisterServerEvent('esx_mafia:putStockItemsBandits')
-- AddEventHandler('esx_mafia:putStockItemsBandits', function(itemName, count)
...
ESX.RegisterServerCallback('esx_mafia:putStockItemsBandits',function(source, cb)
...
RegisterServerEvent('esx_mafia:startHarvestBandits')
AddEventHandler('esx_mafia:startHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopHarvestBandits')
AddEventHandler('esx_mafia:stopHarvestBandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startHarvest2Bandits')
AddEventHandler('esx_mafia:startHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopHarvest2Bandits')
AddEventHandler('esx_mafia:stopHarvest2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startHarvest3Bandits')
AddEventHandler('esx_mafia:startHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopHarvest3Bandits')
AddEventHandler('esx_mafia:stopHarvest3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startHarvest4Bandits')
AddEventHandler('esx_mafia:startHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopHarvest4Bandits')
AddEventHandler('esx_mafia:stopHarvest4Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startCraftBandits')
AddEventHandler('esx_mafia:startCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopCraftBandits')
AddEventHandler('esx_mafia:stopCraftBandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startCraft2Bandits')
AddEventHandler('esx_mafia:startCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopCraft2Bandits')
AddEventHandler('esx_mafia:stopCraft2Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:startCraft3Bandits')
AddEventHandler('esx_mafia:startCraft3Bandits', function()
  local _source = source
...
RegisterServerEvent('esx_mafia:stopCraft3Bandits')
AddEventHandler('esx_mafia:stopCraft3Bandits', function()
  local _source = source
...
-- ESX.RegisterServerCallback('esx_mafia:getArmoryWeaponsBandits',function(source, cb)
...
ESX.RegisterServerCallback('esx_mafia:addArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_mafia:removeArmoryWeaponBandits',function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_mafia:buyBandits',function(source, cb, amount)
...
-----------------------------------------------------------------------------------------------------------------------
ESX.RegisterServerCallback('esx_mafia:getBlackMoneySociety', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
  local blackMoney = 0
  local items      = {}
  ...
  TriggerEvent('esx_datastore:getSharedDataStore', 'society_mafia_weapons', function(store)
...
RegisterServerEvent('esx_mafia:getItem')
AddEventHandler('esx_mafia:getItem', function(type, item, count)
...
RegisterServerEvent('esx_mafia:putItem')
AddEventHandler('esx_mafia:putItem', function(type, item, count)
...
ESX.RegisterServerCallback('esx_mafia:getPlayerInventory2', function(source, cb)
  local _source = source
  local xPlayer    = ESX.GetPlayerFromId(_source)
